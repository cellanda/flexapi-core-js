...
var propertySettingsDefault = require("./property-settings-default.js");
var PropertyBuilder = require("./property-builder.js");
var Module = require("./module.js");

var Mapper = function (prevMapper, logger, containingModule) {
    var _public = {
        settings: {
            property: prevMapper ? prevMapper.settings.property : propertySettingsDefault(new PropertySettings()),
            logger: logger || (prevMapper ? prevMapper.settings.logger : new Logger())
        },

        parameters: {},

        containingModule: containingModule || (prevMapper ? prevMapper.containingModule : null),
